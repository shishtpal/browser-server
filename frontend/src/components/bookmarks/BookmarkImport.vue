  ...
  >
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div class="flex items-center gap-3">
        <div
          class="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-amber-50 text-amber-600 dark:bg-amber-900/20 dark:text-amber-400"
        >
      ...
      <div class="flex items-center gap-2">
        <input
          ...
          accept=".html,.htm"
          @change="onFileChange"
          class="block w-full max-w-40 min-w-0 rounded-lg border border-gray-300 bg-white px-2 py-1.5 text-xs file:mr-2 file:rounded-md file:border-0 file:bg-amber-50 file:px-2 file:py-0.5 file:text-[10px] file:font-black file:text-amber-700 file:transition hover:file:bg-amber-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:file:bg-amber-900/20 dark:file:text-amber-400"
        />
        <button
          type="button"
          @click="doImport"
          ...
          :class="
            importing
              ? 'bg-slate-400'
              : 'bg-gradient-to-r from-amber-500 to-orange-600 hover:-translate-y-0.5 hover:shadow-md'
          "
        >
