<template>
  ...
  >
    <svg
      class="h-3 w-3 shrink-0 text-slate-400 transition"
  ...
  >
    ...
    <div class="flex shrink-0 gap-1 opacity-0 transition group-hover:opacity-100">
      <button
        ...
        class="rounded-lg px-2 py-1 text-[10px] font-black text-slate-500 transition hover:bg-cyan-50 hover:text-cyan-700 dark:hover:bg-cyan-900/10 dark:hover:text-cyan-400"
      >
        Edit
      </button>
      <button
        ...
        class="rounded-lg px-2 py-1 text-[10px] font-black text-red-500 transition hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
      >
        Delete
      </button>
    </div>
