<template>
  <div class="grid flex-1 place-items-center p-6 text-center">
    <div class="max-w-sm">
      ...
      <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">Create <code class="rounded bg-slate-100 px-1.5 py-0.5 text-xs font-mono dark:bg-white/10">bs-ai-config.json</code> and <code class="rounded bg-slate-100 px-1.5 py-0.5 text-xs font-mono dark:bg-white/10">bs-ai-models.json</code> next to the server, then restart the server.</p>
    </div>
  </div>
</template>