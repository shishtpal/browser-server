      ...
      <div class="mb-3 flex shrink-0 flex-wrap items-center gap-3">
        ...
        <template v-if="selectedCount > 0">
          ...
          <div v-else class="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 dark:border-red-900/40 dark:bg-red-950/20">
            <span class="text-xs text-red-700 dark:text-red-300">Remove {{ selectedCount }} messages?</span>
            <Button variant="danger" size="sm" :loading="saving" loading-text="…" @click="doBulkDelete">Confirm</Button>
