  ...
  >
    ...
    <div class="chat-scroll min-h-0 flex-1 space-y-0.5 overflow-y-auto px-2.5 py-3">
      ...
      >
        ...
        >
        <span
          class="mt-1 block truncate font-mono text-[0.66rem] text-slate-400 dark:text-slate-500"
        >
        ...
        <div class="absolute top-1.5 right-1.5">
          <button
            class="rounded-md p-1 text-slate-400 opacity-0 transition group-hover:opacity-100 hover:bg-slate-200 hover:text-slate-700 dark:hover:bg-white/10 dark:hover:text-white"
          ...
          <div
            ...
            class="absolute top-8 right-0 z-20 w-32 rounded-lg border border-slate-200 bg-white p-1 text-[0.8rem] shadow-lg dark:border-white/10 dark:bg-slate-900"
          >
            <button
