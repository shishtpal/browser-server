<template>
  ...
  >
    <div
      class="absolute top-4 left-3 h-3 w-3 rounded-full border-3 border-white bg-violet-500 shadow-sm dark:border-slate-800"
    ></div>
    <div class="pl-7">
      <div class="flex items-start justify-between gap-3">
        <div class="min-w-0">
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            ...
            <span
              ...
              class="rounded-md bg-violet-50 px-2 py-0.5 text-[10px] font-bold text-violet-700 transition-colors dark:bg-violet-900/20 dark:text-violet-400"
            >
        ...
        <button
          ...
          class="shrink-0 rounded-lg bg-red-50 px-3 py-1.5 text-xs font-black text-red-700 transition hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30"
        >
          Delete
        </button>
      </div>
