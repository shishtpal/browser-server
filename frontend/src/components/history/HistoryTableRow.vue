  ...
  <tr class="transition hover:bg-violet-50/60 dark:hover:bg-violet-900/20">
    ...
    <td class="px-3 py-3">
      <span
        ...
        class="rounded-md bg-violet-50 px-2 py-1 text-[10px] font-bold whitespace-nowrap text-violet-700 transition-colors dark:bg-violet-900/20 dark:text-violet-400"
      >
