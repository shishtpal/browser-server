<template>
  <div class="space-y-3">
    ...
    <!-- Filters Toolbar -->
    <div
      class="flex flex-wrap items-center gap-2.5 rounded-2xl border border-slate-200/80 bg-gradient-to-r from-slate-50/80 to-white/60 px-3 py-2.5 shadow-sm backdrop-blur-sm dark:border-slate-700/60 dark:from-slate-800/60 dark:to-slate-800/30"
    >
      <!-- Status Tabs -->
        ...
        >
          ...
          >
            <span class="flex items-center gap-1">
              ...
              {{ selectedPriority }}
              <svg class="h-3 w-3 opacity-60 transition-opacity hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
const selectedUserId = defineModel<number | null>('selectedUserId', { required: true })
