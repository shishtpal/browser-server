  ...
  >
    <div class="flex items-start gap-3">
      ...
      <div class="min-w-0 flex-1">
        <div>
          <div class="flex items-center gap-2">
            ...
            <span
              v-if="todo.pinned"
              class="rounded-full bg-indigo-50 px-1.5 py-0.5 text-[10px] font-black text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-300"
              >Pinned</span
            >
          ...
          <p
            ...
            class="mt-0.5 line-clamp-2 text-xs leading-5 text-slate-500 transition-colors dark:text-slate-400"
      ...
      <div class="flex shrink-0 flex-col gap-0.5">
        <button
          type="button"
          class="drag-handle cursor-grab rounded px-1 py-0.5 text-slate-400 transition hover:text-slate-600 active:cursor-grabbing"
        ...
        <button
          ...
          :class="
            todo.pinned
              ...
              : 'text-slate-500 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-500/10'
          "
        >
        ...
        <button
          ...
          class="rounded px-2 py-1 text-[10px] font-black text-emerald-600 transition hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/20"
        >
          Restore
        </button>
        <button
          ...
          class="rounded px-2 py-1 text-[10px] font-black text-amber-600 transition hover:bg-amber-50 dark:text-amber-400 dark:hover:bg-amber-900/20"
        >
          Archive
        </button>
        <button
          ...
          class="rounded px-2 py-1 text-[10px] font-black text-slate-500 transition hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-500/10 dark:hover:text-indigo-400"
        >
          Edit
        </button>
        <button
          type="button"
          @click="confirmDelete"
          class="rounded px-2 py-1 text-[10px] font-black text-red-500 transition hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
        >
          Delete
        </button>
      </div>
