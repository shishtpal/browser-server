...
func gitDiff(paths config.PathsConfig) func(ctx context.Context, raw json.RawMessage) (any, error) {
	return func(ctx context.Context, raw json.RawMessage) (any, error) {
		...
		diff, err := runGitWithLimit(ctx, a.WorkingDir, limitsFrom(ctx).gitMaxDiffOutput, paths, args...)
		if err != nil {
			return nil, err
		}
