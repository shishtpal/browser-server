...
func registerGitLog(r *Registry, paths config.PathsConfig) {
	r.add(Tool{
		Name:        "git_log",
		...
		Execute:     gitLog(paths),
	})
}

func gitLog(paths config.PathsConfig) func(ctx context.Context, raw json.RawMessage) (any, error) {
