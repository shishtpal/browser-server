...
func registerGitPull(r *Registry, paths config.PathsConfig) {
	r.add(Tool{
		Name:        "git_pull",
		Category:    "Git Operations",
		Description: "Pull changes from a remote repository",
		Schema:      json.RawMessage(gitPullSchema),
		Execute:     gitPull(paths),
	})
}

func gitPull(paths config.PathsConfig) func(ctx context.Context, raw json.RawMessage) (any, error) {
