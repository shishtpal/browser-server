...
func registerGitPush(r *Registry, paths config.PathsConfig) {
	r.add(Tool{
		Name:        "git_push",
		Category:    "Git Operations",
		Description: "Push commits to a remote repository",
		Schema:      json.RawMessage(gitPushSchema),
		Execute:     gitPush(paths),
	})
}

func gitPush(paths config.PathsConfig) func(ctx context.Context, raw json.RawMessage) (any, error) {
